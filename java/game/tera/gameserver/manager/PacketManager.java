...
import tera.gameserver.network.serverpackets.S_Account_Package_List;
import tera.gameserver.network.serverpackets.S_Confirm_Invite_Code_Button;
import tera.gameserver.network.serverpackets.S_Load_Account_Setting;
import tera.gameserver.network.serverpackets.S_Update_Contents_On_Off;
...
public final class PacketManager
{
	...
	public static void showPlayerList(UserClient client, Account account)
	{
		...
		client.sendPacket(S_Load_Account_Setting.getInstance(), true);
		client.sendPacket(S_Account_Package_List.getInstance(), true);
		client.sendPacket(S_Confirm_Invite_Code_Button.getInstance(), true);
		client.sendPacket(S_Update_Contents_On_Off.getInstance(2), true);
		client.sendPacket(S_Update_Contents_On_Off.getInstance(3), true);
		client.sendPacket(S_Update_Contents_On_Off.getInstance(4), true);
	}
