 ...
 */
public class NoBattleEffect extends AbstractEffect
{
	/**
	 ...
	 */
	public NoBattleEffect(EffectTemplate template, Character effector, Character effected, SkillTemplate skill)
	{
