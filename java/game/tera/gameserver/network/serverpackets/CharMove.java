 ...
 */
public class CharMove extends ServerPacket
{
	private static final ServerPacket instance = new CharMove();

	public static CharMove getInstance(Character actor, MoveType type, float x, float y, float z, int heading, float targetX, float targetY, float targetZ)
	{
		CharMove packet = (CharMove) instance.newInstance();
	...
	{
		return ServerPacketType.S_NPC_LOCATION;
	}
