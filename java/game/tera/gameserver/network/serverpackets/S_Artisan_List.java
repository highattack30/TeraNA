...
public class S_Artisan_List extends ServerConstPacket
{
	private static final S_Artisan_List instance = new S_Artisan_List();

	public static S_Artisan_List getInstance()
	{
		return instance;
	}
